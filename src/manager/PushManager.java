...
public class PushManager {
	...
	public void push(int errcode, String details, String name, String ip) {
	    ...
	    if(!this.Errlog.contains(name+"-Code:"+errcode) && errcode != 5) {
	    	//errcode No. 5 happens all the time... not realy interesting just spammy, so blocked
	...
	private void sendPush(String messagetext) {
		...
		try {
			...
			this.controll.toErrorPrint("! ~~~~ FEHLER:Pushover: " + e);
		}
